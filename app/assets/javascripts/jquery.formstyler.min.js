...
(function (d) {
    d.fn.styler = function (n) {
        n = d.extend({idSuffix: "-styler", browseText: "\u0412\u044b\u0431\u0440\u0430\u0442\u044c", selectVisibleOptions: 0, singleSelectzIndex: "100"}, n);
        return this.each(function () {
            ...
            l += r;
            a.is(":checkbox") ? a.css({position: "absolute",
                left: -9999}).each(function () {
                ...
                }) : a.is(":radio") ? a.css({position: "absolute", zIndex: "-5"}).each(function () {
                if (1 >
                    a.next("span.jq-radio").length) {
            ...
            }) : a.is(":file") ? a.css({position: "absolute", top: "-50%",
                right: "-50%", fontSize: "200px", opacity: 0}).each(function () {
                    ...
                    var b = function () {
                        ...
                        function r() {
                            for (e = 0; e < f.length; e++) {
                                ...
                                void 0 !== f.eq(e).attr("class") && (c = " " + f.eq(e).attr("class"));
                                a = '<li class="' + b + c + '">' + f.eq(e).text() + "</li>";
                                f.eq(e).parent().is("optgroup") && (void 0 !== f.eq(e).parent().attr("class") && (d = " " + f.eq(e).parent().attr("class")), a = '<li class="' + b + c + " option" + d + '">' + f.eq(e).text() + "</li>", f.eq(e).is(":first-child") && (a = '<li class="optgroup' + d + '">' + f.eq(e).parent().attr("label") + "</li>" +
                                    a));
                                w += a
                            }
                        }

                        var f = a.find("option"), w = "";
                        if (a.is("[multiple]")) {
                            ...
                            var j = h.find("ul"), g = h.find("li").attr("unselectable", "on").css({"-webkit-user-select": "none", "-moz-user-select": "none", "-ms-user-select": "none", "-o-user-select": "none", "user-select": "none"}), t = a.attr("size"), u = j.outerHeight(), x = g.outerHeight();
                            ...
                            var k = d("<span" + l + ' class="jq-selectbox jqselect' + q +
                                '" style="display: inline-block; position: relative; z-index:' + n.singleSelectzIndex + '"><div class="select" style="float: left"><div class="text"></div><b class="trigger"><i class="arrow-up"></i><i class="arrow-down"></i></b></div></span>');
                            a.after(k).css({position: "absolute", left: -9999});
                            var t = k.find("div.select"), v = k.find("div.text"), u = f.filter(":selected");
                            u.length ? v.text(u.text()) : v.text(f.first().text());
                            if (a.is(":disabled"))k.addClass("disabled"); else {
                                r();
                                var c = d('<div class="dropdown" style="position: absolute; overflow: auto; overflow-x: hidden"><ul style="list-style: none">' +
                                    w + "</ul></div>");
                                k.append(c);
                                var m = c.find("li");
                                ...
                                t.click(function () {
                                    a.focus();
                                    var e = d(window), f = k.offset().top, j = e.height() - s - (f - e.scrollTop()), g = n.selectVisibleOptions, h = 6 * p, l = p * g;
                                    0 < g && 6 > g && (h = l);
                                    0 > j || j < h ? (c.height("auto").css({top: "auto", bottom: y}), c.outerHeight() > f - e.scrollTop() - 20 && (c.height(Math.floor((f -
                                        e.scrollTop() - 20) / p) * p), 0 < g && 6 > g ? c.height() > h && c.height(h) : 6 < g && c.height() > l && c.height(l))) : j > h && (c.height("auto").css({bottom: "auto", top: y}), c.outerHeight() > j - 20 && (c.height(Math.floor((j - 20) / p) * p), 0 < g && 6 > g ? c.height() > h && c.height(h) : 6 < g && c.height() > l && c.height(l)));
                                    ...
                                    c.scrollTop(c.scrollTop() + m.filter(".selected").position().top - c.innerHeight() / 2 + p / 2);
                                    b(c);
                                    return!1
                                });
                                m.hover(function () {
                                ...
                                c.mouseout(function () {
                                    c.find("li.sel").addClass("selected")
                                });
                                a.change(function () {
                                    ...
                                    c.scrollTop(c.scrollTop() + m.filter(".selected").position().top);
